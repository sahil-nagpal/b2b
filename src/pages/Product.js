...
const ProductPage = ()=>{
	const demoData = [
		...
		{
			"birth": "600 BBY, Nal Hutta",
			"description": "Jabba Desilijic Tiure, better known as Jaba and often called the \"Bloated One,\" though never to his face, was one of the most notorious Hutt crime lords in the galaxy, who governed a large criminal empire located in the Outer Rim Territories from his desert palace on Tatooine. At the height of his power, Jabba was one of the most powerful crime lords in the galaxy, even having contact with Prince Xizor, the head of the Black Sun Syndicate.",
			"gender": "Hermaphrodite",
			"height": "3.9 meters long\n1.75 meters tall",
			"image": "http://img1.wikia.nocookie.net/__cb20080409144511/starwars/images/e/e5/Jabba_Boonta_Eve.jpg",
			"name": "Jaba",
